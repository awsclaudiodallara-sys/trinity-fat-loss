...
export const ChatPreview: React.FC<ChatPreviewProps> = ({ trioId, onOpenChat }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="flex items-start space-x-2">
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-1">
                  <span className="font-medium text-sm text-gray-800">{message.user_name}</span>
      ...
      <div className="mt-3 text-xs text-gray-500 text-center">
        Last activity: {recentMessages.length > 0 ? formatTimestamp(recentMessages[0].timestamp) : 'No messages'}
      </div>
    </div>
  );
};
